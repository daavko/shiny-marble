...
/**
 * This file is a vendored copy of maplibre-gl-js/src/geo/lng_lat.ts from MapLibre GL JS v5.24.0,
...
export class LngLat {
    ...
    static convert(input: LngLatLike): LngLat {
        ...
        if (!Array.isArray(input) && typeof input === 'object') {
            return new LngLat('lng' in input ? input.lng : input.lon, input.lat);
        }
        throw new Error(
