...
import { earthRadius, LngLat, type LngLatLike } from './lng-lat';

/**
 * This file is a vendored copy of maplibre-gl-js/src/geo/mercator_coordinate.ts from MapLibre GL JS v5.24.0,
